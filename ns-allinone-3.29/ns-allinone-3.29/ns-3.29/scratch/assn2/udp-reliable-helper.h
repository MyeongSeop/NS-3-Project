 ...
 */
#ifndef UDP_RELIABLE_HELPER_H
#define UDP_RELIABLE_HELPER_H
 ...
 */
class UdpReliableServerHelper
{
public:
  /**
   * Create UdpReliableServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  UdpReliableServerHelper (uint16_t port);
 ...
 */
class UdpReliableClientHelper
{
public:
  /**
   * Create UdpReliableClientHelper which will make life easier for people trying
   ...
   */
  UdpReliableClientHelper (Address ip, uint16_t port);
  /**
   * Create UdpReliableClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  UdpReliableClientHelper (Address addr);
